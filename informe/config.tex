...
\newcommand{\titulolargo}{Dimensionamiento de caja para parlante}
\newcommand{\materia}{Electroacútica - 66.68}
\newcommand{\fiuba}{Facultad de Ingeniería - UBA}
\newcommand{\cuatrimestre}{$2^{do}$ c. 2020} %\sptext{do} $1\textsuperscript{er}$
...
\newcommand{\thedate}{10 de Diciembre de 2020}
